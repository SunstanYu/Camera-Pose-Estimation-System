...
if __name__ == '__main__':
    obj_points, img_points, size = getPoints("E:/Code/YoloProject/ObjectLocation/calibrate_data/26mm/*.jpg", 6, 4)
    # 标定
    ...
    print("rvecs:\n", rvecs)  # 旋转向量  # 外参数
    print("tvecs:\n", tvecs)  # 平移向量  # 外参数
    with open("calibrate_data/26mm/calibrate_info.txt", "w") as f:
        # 将变量值写入文件
        f.write("ret:" + str(ret) + "\n")
        f.write("mtx:\n" + str(mtx) + "\n")
        f.write("dist:\n" + str(dist) + "\n")
